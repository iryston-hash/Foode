...
// APi key 19e90a0c-30fc-4a9e-9815-cdef6e1fb29c
...
const receiveRecipe = async function () {
  try {
      ...
      <div class="recipe__details">
        <div class="recipe__info">
          <svg class="recipe__info-icon">
            <use href="${icons}/img/icons.svg#icon-clock"></use>
          </svg>
        ...
        <div class="recipe__info">
          <svg class="recipe__info-icon">
            <use href="${icons}/img/icons.svg#icon-users"></use>
          </svg>
        ...
        <button class="btn--round">
          <svg class="">
            <use href="${icons}/img/icons.svg#icon-bookmark-fill"></use>
          </svg>
        </button>
      </div>
          ...
          .map(ing => {
            ...
            <li class="recipe__ingredient">
              <svg class="recipe__icon">
                <use href="${icons}/img/icons.svg#icon-check"></use>
              </svg>
...
['hashchange','load'].forEach(ev => window.addEventListener(ev, receiveRecipe))
...
//                 `;
//                 })
//                 // turning multiple arrays into one big. by using join method
//                 .join('')}
//           </div>
